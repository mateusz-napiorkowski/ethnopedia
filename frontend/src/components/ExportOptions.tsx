...
import { getXlsxWithArtworksData, getArtworksFilesArchive } from "../api/dataExport"
...
const ExportOptions = ({onClose, selectedArtworks, initialFilename, collectionIds}: Props) => {
    ...
    const [archiveFilename, setArchiveFilename] = useState("archiwum.zip")
                    ...
                    <div className="relative bg-white rounded-lg shadow dark:bg-gray-800 border dark:border-gray-600">
                        ...
                        <div className="flex flex-row space-x-2 text-sm px-4">
                                    <span className="py-1">
                                        ...
                                        <label> Eksportuj dane zaznaczonych utworów</label>
                                    </span>
                                    <span className="py-1">
                                        <input
                                            type="radio"
                                        ...
                                        <label> Eksportuj dane wyników wyszukiwania</label>
                                    </span>
                                    <span className="py-1">
                                        <input 
                                            type="radio"
                                        ...
                                        <label> Eksportuj dane wszystkich utworów</label>
                                    </span>
                            </div>
                        <div>
                            <p className="flex py-2 px-4 text-lg font-medium">Eksport metadanych do pliku arkusza kalkulacyjnego</p>          
                            ...
                            <div className="flex flex row justify-between">
                                <div className="flex flex-row items-center space-x-2 text-sm px-4 py-2">
                        ...
                        <div>
                            <p className="flex py-2 px-4 text-lg font-medium">Eksport plików powiązanych z wybranymi utworami</p>
                            <div className="flex flex row justify-between">
                                <div className="flex flex-row items-center space-x-2 text-sm px-4 py-2">
                                    <label className="px-1 py-1">
                                        Nazwa archiwum:
                                ...
                                <div className="flex justify-end px-4 py-4">  
                                    <button
                                        ...
                                        dark:focus:ring-primary-800 font-semibold text-white bg-gray-800 hover:bg-gray-700 border-gray-800"
                                        type="submit"
                                        onClick={() => getArtworksFilesArchive(
                                            collectionIds, 
                                            exportExtent,
                                            selectedArtworks,
                                            searchParams,      
