...
jest.mock('../../api/dataImport', () => ({
    ...
    ) => mockImportData(importData, jwtToken, collectionName),
...
const renderComponent = (
        path = "/",
        collectionData: Collection | undefined = undefined,
    ...
    return render(
        <UserContext.Provider value={ userContextProps }>
            ...
            <MemoryRouter initialEntries={[path]}>
                <Routes>
                    <Route path={path} element={<ImportOptions onClose={mockOnClose} collectionData={collectionData}/>}/>
                </Routes>  
            </MemoryRouter>
        </QueryClientProvider>
...
describe("Import options tests", () => {
    ...
    it("should render menu for importing data as new collection, next button should be disabled", () => {           
